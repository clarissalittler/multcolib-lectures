...
** Arrays
   ...
   More generally, the concept of a "list" describes everything from a hastily made scrawling of directions to general containers of thigns like bookshelves and clothes racks.
   ...
   These lists in JavaScript are called arrays and they're the first kind of compound container that we'll see in JavaScript. In JavaScript, we make arrays by putting expressions between square brackets and separated by commas as in =[1,3,"thing"]=. 
