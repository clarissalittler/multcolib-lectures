...
*** Variables-as-shorthand
    ...
    where =var= is the start of the expression that tells JavaScript that you are /declaring/ a variable and the expression to the right of the equals sign is the going to be evaluated to give the initial value of the variable.

    Essentially, you're declaring a new pronoun with 
