...
\usepackage{framed}
\usepackage{hyperref}
\title{Handout for Web Development}
\author{}
\date{}
...
\section{Getting Started}
  ...
  The first step is to download the slides so you can follow along with the lectures: \url{https://github.com/clarissalittler/multcolib-lectures/blob/master/WebProgramming.pdf}
